          ...
          return (
            <SwiperSlide key={i}>
              <button
                ...
                className="card p-3.5 w-full text-left block border-l-[3px] relative overflow-hidden"
              ...
              >
                ...
                <div className="relative">
                  ...
                  {item.student_note && (
                    <div className="mt-2.5 text-[11px] text-[#10b981] bg-[#10b981]/8 rounded-lg px-2.5 py-1.5 flex items-start gap-1.5">
